...
export default function DepreciationPage() {
  ...
  const displayResults =
    existingResults && existingResults.total > 0 ? existingResults : null;
  ...
  const confirmLabel =
    existingResults &&
    existingResults.total > 0 &&
    existingResults.calculated_at
